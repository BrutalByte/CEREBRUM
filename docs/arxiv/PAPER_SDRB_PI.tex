...
analytically maps all nine scoring hyperparameters
(terminal relation boost, fan-out amplification, path corroboration,
first-hop disambiguation, IDF hub penalty, community vote weight,
branch evidence combination, beam width, and power-law exponent)
to measurable graph statistics via IDF theory, Bayesian evidence combination,
and Newman-Girvan modularity.
