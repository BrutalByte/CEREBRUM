...
Docs: \url{https://brutalbyte.github.io/CEREBRUM/}.
Wiki: \url{https://github.com/BrutalByte/CEREBRUM/wiki}.
\end{abstract}
...
(v2.77.0), which provides training-free multi-hop KG reasoning with
