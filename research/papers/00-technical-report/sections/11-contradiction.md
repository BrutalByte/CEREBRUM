...
Contradiction confidence was previously a binary signal (detected vs. not detected). In v2.71.0, the system uses **Noisy-OR fusion** over all reverse paths that could corroborate or refute a contradiction:
