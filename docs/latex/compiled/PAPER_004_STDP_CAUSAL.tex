...
\subsection{5. Recent Advances (v2.24.0 -\textgreater  v2.51.0)}

The STDP causal discovery pipeline has been hardened and extended since v2.24.0. The following describes key devel\-opments relevant to this paper.
...
\textbf{Test Coverage.} The STDP subsystem is covered by dedicated adversarial and throughput regression tests within the 1,357-test v2.51.0 suite, including constant-latency verif\-ication across accumulated pair counts of up to 10^6 pairs.
