...
and custom stages can be inserted at any point. Default throughput on a single CPU core
is $\approx$50,000 triples/second for pure normalization; STDP discretization adds
$O(1)$ amortized overhead per triple via Lazy Decay.
