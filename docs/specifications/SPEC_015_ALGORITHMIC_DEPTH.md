...
### 1. Introduction
Phase 17 adds five composable algorithmic enhancements to the core CORTEX reasoning pipeline. Each component is independently activatable; none are enabled by default (preserving v2.24.0 behavioral compatibility). The five components are:
...
### 7. Implementation Notes (v2.24.0)
