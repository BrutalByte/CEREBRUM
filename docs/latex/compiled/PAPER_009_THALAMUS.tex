...
\subsubsection{3. Scalability: Parallel Prepro\-cessing (v2.51.0)}
...
\textbf{Full Pipeline Test Coverage.} The THALAMUS pipeline is now covered by 2175+ tests (up from 994 at v2.24.0). New test categories include:
\begin{itemize}
