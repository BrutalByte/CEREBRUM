...
*   **Dynamic Adaptation**: The v1.2.0 release fixes the "Zombie Bridge" problem, ensuring that relays are automatically updated or pruned when communities are re-balanced.
