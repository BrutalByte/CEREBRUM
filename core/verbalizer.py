...
_BUILTIN_TEMPLATES: Dict[str, Tuple[str, str, str]] = {
    ...
    "REM_SYNTHESIZED_SynapticBridge": ("{src} bridges to {dst} via high similarity (cross-component SynapticBridge)",
                                 "{dst} bridges to {src} via high similarity (cross-component SynapticBridge)",
