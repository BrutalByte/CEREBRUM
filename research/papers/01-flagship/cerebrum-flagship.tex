...
\textbf{Hardware.} All experiments were run on a single workstation:
AMD Ryzen 9 9950X3D (16-core), NVIDIA GeForce RTX 5090 (32GB VRAM), 62GB system RAM,
Windows 11 Pro. No distributed computing was used.
...
all measured in a single session on the same workstation (AMD Ryzen 9 9950X3D,
RTX 5090, 62GB RAM) to eliminate inter-run environment variance.}
\label{tab:webqsp}
\begin{tabular}{lccc}
\toprule
