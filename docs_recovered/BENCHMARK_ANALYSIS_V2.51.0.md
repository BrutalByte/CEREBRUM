# CEREBRUM v2.51.0: Benchmark Performance Analysis

This document provides a comparative analysis of CEREBRUM's performance in its state (v2.51.0) versus baseline, focusing on MetaQA and Hetionet results.
...
| Query Type | v2.33.1 (Phase 143) | CEREBRUM v2.51.0 (Phase 167) | Delta |
| :--- | :--- | :--- | :--- |
...
*   **STRB (Phase 167)**: The jump in 1-hop accuracy to 99%+ is driven by Semantic Terminal Relation Boost, which virtually eliminates "wrong relation" noise in zero-config scenarios.
...
| Task | Baseline | CEREBRUM (v2.51.0) |
| :--- | :--- | :--- |
...
## 5. Conclusion
CEREBRUM v2.51.0 (Phase 167) solidifies the framework's "Zero-Config" goal.
