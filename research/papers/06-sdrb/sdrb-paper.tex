...
\textbf{Subsequent results (post-submission).} Phase 212 zero-config validation
(all 39,093 MetaQA questions) establishes canonical zero-config H@1 of 83.2\%
(1-hop), 63.3\% (2-hop), and 56.8\% (3-hop) with H@10 reaching 99.0\%, 94.3\%,
and 90.7\%. Phase 213 (sentence-transformer embeddings, hub-homogeneous regime)
achieves 66.8\% H@1 on 3-hop. Full results are in
\texttt{docs/BENCHMARK\_CANONICAL.md} in the repository.
...
Buchorn, B.A. (2026).
CEREBRUM v2.71.0: Complete Technical Specification for Autonomous Knowledge Graph Reasoning.
