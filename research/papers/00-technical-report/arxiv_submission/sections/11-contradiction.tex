...
\subsection*{3. Recent Advances (v2.24.0 -> v2.51.0)}
...
Contradiction confidence was previously a binary signal (detected vs. not detected). In v2.51.0, the system uses \textbf{Noisy-OR fusion} over all reverse paths that could corroborate or refute a contradiction:
