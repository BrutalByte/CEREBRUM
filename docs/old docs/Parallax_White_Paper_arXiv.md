...
**Bryan Alexander Buchorn** / Independent Researcher · bryan.alexander@buchorn.com
...
| **CEREBRUM CSA + Bridge Bonus** | **No** | **0.960** | **0.713** | **0.248** | **<7ms** |
...
| + Bayesian beam ($s=5$) | 0.248 | +68% | Probabilistic traversal |
...
*© Bryan Alexander Buchorn — All rights reserved. Version 0.3.6 — March 2026*
