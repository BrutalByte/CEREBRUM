...
### 3. Recent Advances (v1.2.0 → v1.9.8)
...
Contradiction confidence was previously a binary signal (detected vs. not detected). In v1.9.8, the system uses **Noisy-OR fusion** over all reverse paths that could corroborate or refute a contradiction:
