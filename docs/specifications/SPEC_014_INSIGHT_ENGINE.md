...
- **Hallucination Pruning**: As of v1.2.0, the system autonomously identifies and prunes stale insights that fail independent triangulation, ensuring graph integrity over long operational windows.
