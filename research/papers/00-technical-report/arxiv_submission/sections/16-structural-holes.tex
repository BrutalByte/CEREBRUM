...
\subsection*{5. Recent Advances (v2.51.1 -> v2.52.0)}
...
Phase 54 (v2.52.0) & \textbf{1,357} \\
Phase 57 (v2.52.0) & \textbf{1,490+} \\
\bottomrule
\end{tabular}
\end{table}
