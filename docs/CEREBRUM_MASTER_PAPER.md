...
| 3-hop | 12.5% | **45.1%** (full 14,274-question run) | 71.0% |

Published baselines (3-hop): GraftNet 22.8%, EmbedKGQA 29.8%. CEREBRUM Phase 153 achieves **+98% relative improvement over GraftNet** and **+51% over EmbedKGQA** using only graph structure — no LLMs, no training data, no KG embeddings.
...
| MetaQA 3-hop | H@1 / H@10 | **45.1% / 71.0%** (Phase 153, full 14,274-question run) |
