...
def test_sentence_hub_homogeneous_overrides():
    """Phase 213: sentence hub_homogeneous uses vote_base=0.6777 (lower than random 0.72)."""
    ...
    # vote_weight: sentence vote_base=0.6777 vs random 0.72
    assert p_sent.vote_weight < p_rand.vote_weight
    assert p_sent.vote_weight == pytest.approx(0.6777 + 0.15 * 0.5, abs=1e-4)
