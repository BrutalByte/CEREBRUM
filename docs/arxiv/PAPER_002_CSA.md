...
### 5. Conclusion
CSA provides a scalable, Interpretable AI (XAI) alternative to black-box graph embeddings. By grounding attention in the structural consensus of the graph, it enables complex multi-hop reasoning that is both computationally efficient and mathematically verifiable. In CEREBRUM v1.9.8, the 10-parameter CSA formula with online per-community learning achieves MetaQA H@1 of 46.1% (1-hop), 30.0% (2-hop), and 12.5% (3-hop), alongside WebQSP H@1=6.27%, H@10=20.84%, and MRR=10.66% — establishing CSA as a competitive and interpretable alternative to embedding-based KG reasoning.

---

## 6. Recent Advances (v1.2.0 → v1.9.8)

The CSA formula and its associated learning infrastructure have undergone significant expansion since v1.2.0. The following describes the key advances relevant to this paper.
