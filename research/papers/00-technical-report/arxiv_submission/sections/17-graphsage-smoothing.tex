...
\subsubsection*{2.1 The Smoothing Operation}
...
\texttt{smooth\_with\_graphsage(embeddings: Dict[str, np.ndarray], G: nx.Graph) -> Dict[str, np.ndarray]} implements the operation in a single forward pass over all edges:
...
\subsubsection*{2.3 Computational Complexity}
...
\subsection*{3. Prior Art Analysis}
