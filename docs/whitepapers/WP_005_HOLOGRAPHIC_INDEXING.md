...
*   **Verified Provenance (v1.2.0)**: Every federated hop is protected by **HMAC-SHA256 signatures**, ensuring that reasoning paths cannot be spoofed or hallucinated by malicious actors.
