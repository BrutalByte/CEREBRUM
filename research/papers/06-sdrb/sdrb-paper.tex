...
\begin{enumerate}
  ...
  \item \textbf{An empirical structural finding} (\S\ref{sec:fanова}):
...
\fanova{}~\cite{hutter2014fanова} decomposes objective variance across hyperparameter
...
We apply functional ANOVA (\fanova{})~\cite{hutter2014fanова} to the
