...
\subsection*{5. Recent Advances (v2.24.0 -> v2.51.0)}
...
Phase 54 (v2.51.0) & \textbf{1,357} \\
Phase 57 (v2.51.0) & \textbf{1,490+} \\
\bottomrule
\end{tabular}
\end{table}
